...
class VideoConverter:
    def __init__(self, input_video, output_path, resolutions):
        ...
        self.video_id = str(uuid.uuid4())  # unique video id
...
if __name__ == "__main__":
    ...
    input_path = "/Users/asilbekturgunboev/Desktop/video_conversion/video.mp4"
    converter = VideoConverter(input_path, output_path, resolutions)
